    ...
    <div style={{ background: "#E5EEFB" }}>
      <div className="container mx-auto min-h-screen flex flex-col justify-center py-10">
        <div className="w-full max-w-full p-6">
          <h1 className="text-5xl font-semibold text-center mb-6">Find Your Doctor</h1>
          ...
          <form onSubmit={handleSearchSubmit} className="flex flex-col items-center">
            ...
            <button type="submit" className="bg-blue-600 text-white py-3 px-8 rounded-lg hover:bg-blue-500 transition duration-300">
              Search
            </button>
          </form>
        </div>
